...
public class AlumnoMenuActivity extends ListActivity {
	...
	String[] activities = { "AlumnoInsertarActivity",
			"AlumnoConsultarActivity", "AlumnoActualizarActivity",
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		try {
			Class<?> clase = Class.forName("sv.ues.fia.moviles.controlador.alumno."
					+ nombreValue);
