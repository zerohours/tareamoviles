...
public class DocenteActualizarActivity extends Activity implements
		OnClickListener {
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.docente_actualizar, menu);
		return true;
	}
	...
	public void actualizarDocente(View v) {
		...
		helper.abrir();
		String regInsertados = helper.actualizar(docente);
		helper.cerrar();
