...
public class AlumnoActualizarActivity extends Activity implements
		OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		editIdNombreAlumno = (EditText) findViewById(R.id.editIdNombre);
	...
	public void actualizarAlumno(View v) {
		...
		String nombre = editIdNombreAlumno.getText().toString();
		...
		helper.abrir();
		String regInsertados = helper.actualizarAlumno(alumno);
		helper.cerrar();
